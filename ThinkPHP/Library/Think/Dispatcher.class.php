...
class Dispatcher {
     ...
     * @return string
     */
    static private function getSpace($urlCase) {
        $var    =   C('VAR_ADDON');
     ...
     * @return string
     */
    static private function getController(&$paths, $urlCase) {
     ...
     * @return string
     */
    static private function getAction(&$paths, $urlCase) {
     ...
     * @return string
     */
    static private function getModule(&$paths) {
